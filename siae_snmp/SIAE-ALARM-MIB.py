...
# ASN.1 source file://./sm_alarm.mib
...
ObjectIdentity, Counter64, Bits, Gauge32, MibIdentifier, NotificationType, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, IpAddress, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Bits", "Gauge32", "MibIdentifier", "NotificationType", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity")
DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention")
smalarm = ModuleIdentity((1, 3, 6, 1, 4, 1, 3373, 1103, 4))
smalarm.setRevisions(('2015-07-17 00:00', '2015-03-23 00:00', '2015-03-16 00:00', '2014-06-23 00:00', '2014-03-03 00:00', '2014-02-03 00:00', '2013-04-16 00:00',))
if mibBuilder.loadTexts: smalarm.setLastUpdated('201507170000Z')
...
alarmIpSnmpAgentAddress = MibScalar((1, 3, 6, 1, 4, 1, 3373, 1103, 4, 2, 5), Unsigned32()).setMaxAccess("accessiblefornotify")
...
mibBuilder.exportSymbols("SIAE-ALARM-MIB", alarmAntiFlooding=alarmAntiFlooding, alarmLogEndTimeFilter=alarmLogEndTimeFilter, alarmAntiFloodingWindow=alarmAntiFloodingWindow, alarmLogObjectVal=alarmLogObjectVal, alarmLogActionRequest=alarmLogActionRequest, alarmActiveTable=alarmActiveTable, alarmSyntesysMajorSeverityCode=alarmSyntesysMajorSeverityCode, alarmSyntesysMinor=alarmSyntesysMinor, alarmLogStartTimeFilter=alarmLogStartTimeFilter, alarmAntiFloodingLowWater=alarmAntiFloodingLowWater, alarmLogManagedObjectFilter=alarmLogManagedObjectFilter, alarmMibVersion=alarmMibVersion, alarmLogObjectId=alarmLogObjectId, alarmLogObjectSev=alarmLogObjectSev, alarmActiveDescription=alarmActiveDescription, alarmSyntesysCriticalSeverityCode=alarmSyntesysCriticalSeverityCode, alarmLogFTPStatusTrapNotification=alarmLogFTPStatusTrapNotification, alarmActiveFloodingStatus=alarmActiveFloodingStatus, alarmAntiFloodingHighWater=alarmAntiFloodingHighWater, alarmSyntesysMajor=alarmSyntesysMajor, alarmSyntesysCritical=alarmSyntesysCritical, alarmLogFTPfile=alarmLogFTPfile, alarmSyntesysStatusSeverityCode=alarmSyntesysStatusSeverityCode, alarmIpSnmpAgentAddress=alarmIpSnmpAgentAddress, alarmItemTable=alarmItemTable, alarmActiveRecord=alarmActiveRecord, alarmSyntesysWarning=alarmSyntesysWarning, alarmTrap=alarmTrap, alarmActiveObjectVal=alarmActiveObjectVal, alarmActiveObjectId=alarmActiveObjectId, alarmLogEndHourEnable=alarmLogEndHourEnable, AlarmStatus=AlarmStatus, alarmLogFTPStatusTrap=alarmLogFTPStatusTrap, alarmActiveEventTime=alarmActiveEventTime, alarmLogRecord=alarmLogRecord, alarmLogRecordId=alarmLogRecordId, alarmLogStartHourEnable=alarmLogStartHourEnable, AlarmSeverityCode=AlarmSeverityCode, alarmObjectId=alarmObjectId, alarmLogEventTime=alarmLogEventTime, alarmLogFTPStatus=alarmLogFTPStatus, alarmTrapObject=alarmTrapObject, alarmLogAlarmSeverityFilter=alarmLogAlarmSeverityFilter, smalarm=smalarm, alarmDescription=alarmDescription, alarmSyntesysWarningSeverityCode=alarmSyntesysWarningSeverityCode, alarmRecord=alarmRecord, alarmOid=alarmOid, alarmSyntesysStatus=alarmSyntesysStatus, alarmTrapDescription=alarmTrapDescription, PYSNMP_MODULE_ID=smalarm, alarmLogAlarmSeverityEnable=alarmLogAlarmSeverityEnable, alarmLogLastEventTime=alarmLogLastEventTime, siaeNotificationEntry=siaeNotificationEntry, alarmObjectVal=alarmObjectVal, alarmTrapNumber=alarmTrapNumber, alarmSyntesysMinorSeverityCode=alarmSyntesysMinorSeverityCode, alarmLogDescription=alarmLogDescription, alarmLogTable=alarmLogTable)
